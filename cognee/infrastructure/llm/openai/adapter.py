...
class OpenAIAdapter(LLMInterface):
    ...
    async def acreate_structured_output(
        self, text_input: str, system_prompt: str, response_model: Type[BaseModel], tools: list = None
    ) -> BaseModel:
        """
        Generate a response from a user query, with tool/function calling support.
        """
